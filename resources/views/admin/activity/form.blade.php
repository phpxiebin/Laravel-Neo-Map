                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6"><label class="col-sm-3 control-label"><span
                                                class="text-danger">*</span>是否置顶</label>
                                    <div class="col-sm-9">
                                        <input type="radio" name="mark"
                                               value="0" {{ isset($activity)&&$activity->mark?'':'checked=checked' }} />否
                                        <input type="radio" name="mark"
                                               value="1" {{ isset($activity)&&$activity->mark?'checked=checked':'' }} />是
                                    </div>
                                </div>

                                @if(getCurrentAction()['method'] != 'store')
                                <div class="col-sm-6"><label class="col-sm-3 control-label">活动状态</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="col-sm-6"><label class="col-sm-3 control-label">是否隐藏</label>
                                    <div class="col-sm-9">
                                        <select class="form-control" name="display">
                                            <option value="">请选择</option>
                                            <option value="0" {{ isset($activity)&&$activity->display == 0?"selected=selected":'' }}>
                                                显示
                                            </option>
                                            <option value="1" {{ isset($activity)&&$activity->display == 1?'selected=selected':'' }}>
                                                隐藏
                                            </option>
                                        </select>
                                    </div>
